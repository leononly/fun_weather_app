                                                ...
                                                children: <Widget>[
                                                  Container(
                                                      child: weatherBloc.locations[
                                                              ...
                                                              null
                                                          ? BoxedIcon(
                                                              weatherBloc.identifyWeatherIcon(weatherBloc
                                                                  .locations[
                                                                      weatherBloc
                                                                          .selectedIndex]
                                                                      [
                                                                  ...
                                                                  .toList()[0][
                                                                      ...
                                                                      ['icon']
                                                                  .toString())['icon'],
                                                              color: weatherBloc.identifyWeatherIcon(weatherBloc
                                                                  .locations[
                                                                      weatherBloc
                                                                          .selectedIndex]
                                                                      ['weatherData']
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: ListView(
                                    ...
                                    itemExtent: 100,
                                    children: <Widget>[
                                      if (weatherBloc.locations[weatherBloc
                                              .selectedIndex]['weatherData'] !=
                                          null)
                                        ...weatherBloc.locations[
                                                weatherBloc.selectedIndex]
                                                ['weatherData']['weather']
...
//                                    blurRadius: 10,
                                  ...
                                  child: Padding(
                                    ...
                                    child: ListView(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      children: [
                                        if (weatherBloc.forecastDaySelected !=
                                            null)
                                          ...weatherBloc
                                              .forecastDaySelected.values
                            ...
                            .map((i, data) => MapEntry(
                                ...
                                ListTile(
                                  onTap: () {
                                    _tabController.animateTo(0);
                                    weatherBloc
                                        .add(SelectAndFetchWeather(index: i));
                                  },
                                  selected: i == weatherBloc.selectedIndex
                                      ? true
                                      : false,
